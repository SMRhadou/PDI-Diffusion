...
from pdi.datasets.wra.channel import WirelessChannel, WirelessChannelV2, WirelessChannelV3
from pdi.datasets.wra.sample_schema import canonicalize_pd_samples_dict
from pdi.utils.rate_calculator import (
    compute_system_parameters,
    compute_ergodic_rates
)
from pdi.utils.graph_builder import build_interference_graph
...
def main():
    ...
    print("      python -m pdi.cli.wra.build_diffusion_dataset --input <PD_RUN_DIR> --output-root data/wra")
    ...
    if all_match:
        ...
        print("  pdi.cli.wra.build_diffusion_dataset.")
    else:
